...
# **GetElements**
> Element GetElements (List<string> id = null, List<string> name = null, List<string> nodeId = null, string pageLimit = null, string pageStart = null, string previousId = null, List<string> ruleId = null)
...
namespace Example
{
    public class GetElementsExample
    {
        public void main()
        {
            ...
            {
                // Get elements (since 1.8)
                Element result = apiInstance.GetElements(id, name, nodeId, pageLimit, pageStart, previousId, ruleId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
