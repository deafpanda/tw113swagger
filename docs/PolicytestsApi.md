...
[**GetPolicyTestById**](PolicytestsApi.md#getpolicytestbyid) | **GET** /policytests/{rkPolicyTestId} | Get policy test details by ID
...
[**GetPolicyTestRemediation**](PolicytestsApi.md#getpolicytestremediation) | **GET** /policytests/{rkPolicyTestId}/remediation | Get remediation details of a policy test
[**GetPolicyTests**](PolicytestsApi.md#getpolicytests) | **GET** /policytests | Search policy tests
...
# **GetExcludedNodes**
> List<string> GetExcludedNodes (string rkPolicyTestId)
...
namespace Example
{
    public class GetExcludedNodesExample
    {
        public void main()
        {
            ...
            {
                // Get excluded nodes of a policy test (since 1.5)
                List&lt;string&gt; result = apiInstance.GetExcludedNodes(rkPolicyTestId);
...
> List<PolicyTestGroupPath> GetPolicyTestParentGroups (string rkPolicyTestId)
...
namespace Example
{
    public class GetPolicyTestParentGroupsExample
    {
        public void main()
        {
            ...
            {
                // List parent groups for a policy test (since 1.5)
                List&lt;PolicyTestGroupPath&gt; result = apiInstance.GetPolicyTestParentGroups(rkPolicyTestId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
[**List<PolicyTestGroupPath>**](PolicyTestGroupPath.md)
...
Get remediation details of a policy test
...
namespace Example
{
    public class GetPolicyTestsExample
    {
        public void main()
        {
            ...
            {
                // Search policy tests
                List&lt;PolicyTest&gt; result = apiInstance.GetPolicyTests(pageLimit, pageStart, id, name, description, subDescription, trackingId, severity, modifiedTime, importedTime, type, rules, policyId, importedTimeRange);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
