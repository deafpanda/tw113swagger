...
namespace Example
{
    public class GetTaskGroupChildrenExample
    {
        public void main()
        {
            ...
            {
                // Get children of a Task Group (since 1.11)
                TaskGroupChild result = apiInstance.GetTaskGroupChildren(rkTaskGroupId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
[**TaskGroupChild**](TaskGroupChild.md)
...
namespace Example
{
    public class GetTaskGroupsExample
    {
        public void main()
        {
            ...
            {
                // Search all Task Groups (since 1.11)
                TaskGroup result = apiInstance.GetTaskGroups(description, id, importedTime, modifiedTime, name, pageLimit, pageStart, subDescription, trackingId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
