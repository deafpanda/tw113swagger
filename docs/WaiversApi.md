...
[**GetWaiverById**](WaiversApi.md#getwaiverbyid) | **GET** /waivers/{rkWaiverId} | Get waiver details by ID.
[**GetWaivers**](WaiversApi.md#getwaivers) | **GET** /waivers | Search waivers
...
namespace Example
{
    public class GetWaiversExample
    {
        public void main()
        {
            ...
            {
                // Search waivers
                List&lt;Waiver&gt; result = apiInstance.GetWaivers(pageLimit, pageStart, id, name, description, subDescription, policyId, policyName, startTime, expiration, grantedBy, responsible, closed);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
