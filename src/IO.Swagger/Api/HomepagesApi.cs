...
namespace IO.Swagger.Api
{
    ...
    public interface IHomepagesApi : IApiAccessor
    {
        ...
        ApiResponse<Homepage> GetAllWithHttpInfo (List<string> description = null, List<string> id = null, List<string> name = null, List<string> subDescription = null, List<string> trackingId = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Homepage> GetAllAsync (List<string> description = null, List<string> id = null, List<string> name = null, List<string> subDescription = null, List<string> trackingId = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Homepage>> GetAllAsyncWithHttpInfo (List<string> description = null, List<string> id = null, List<string> name = null, List<string> subDescription = null, List<string> trackingId = null);
        /// <summary>
        /// Get homepage details by ID (since 1.1)
        /// </summary>
        /// <remarks>
    ...
    public partial class HomepagesApi : IHomepagesApi
    {
        ...
        /// <summary>
        /// Search homepages (since 1.1) Returns a list of all homepages or only those homepages that match the provided filter criteria.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="description">Descriptions of homepages to fetch. (optional)</param>
        /// <param name="id">IDs of homepages to fetch. (optional)</param>
        ...
        /// <param name="trackingId">Tracking IDs of homepages to fetch. (optional)</param>
        /// <returns>Homepage</returns>
        public Homepage GetAll (List<string> description = null, List<string> id = null, List<string> name = null, List<string> subDescription = null, List<string> trackingId = null)
        {
             ApiResponse<Homepage> localVarResponse = GetAllWithHttpInfo(description, id, name, subDescription, trackingId);
        ...
        /// <param name="trackingId">Tracking IDs of homepages to fetch. (optional)</param>
        /// <returns>ApiResponse of Homepage</returns>
        public ApiResponse< Homepage > GetAllWithHttpInfo (List<string> description = null, List<string> id = null, List<string> name = null, List<string> subDescription = null, List<string> trackingId = null)
        {
        ...
        /// <param name="trackingId">Tracking IDs of homepages to fetch. (optional)</param>
        /// <returns>Task of Homepage</returns>
        public async System.Threading.Tasks.Task<Homepage> GetAllAsync (List<string> description = null, List<string> id = null, List<string> name = null, List<string> subDescription = null, List<string> trackingId = null)
        {
             ApiResponse<Homepage> localVarResponse = await GetAllAsyncWithHttpInfo(description, id, name, subDescription, trackingId);
             return localVarResponse.Data;
        ...
        /// <param name="trackingId">Tracking IDs of homepages to fetch. (optional)</param>
        /// <returns>Task of ApiResponse (Homepage)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Homepage>> GetAllAsyncWithHttpInfo (List<string> description = null, List<string> id = null, List<string> name = null, List<string> subDescription = null, List<string> trackingId = null)
        {
        ...
        /// <summary>
        /// Get homepage details by ID (since 1.1) Returns summary details for an individual homepage.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkHomepageId">rkHomepageId to fetch</param>
        /// <returns>Homepage</returns>
