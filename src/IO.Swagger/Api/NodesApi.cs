...
namespace IO.Swagger.Api
{
    ...
    public interface INodesApi : IApiAccessor
    {
        ...
        ApiResponse<Dictionary<string, string>> CreateNodeAclWithHttpInfo (string rkNodeId, Object body);
        /// <summary>
        ...
        /// <param name="rkNodeId">ID of Node to fetch the ACL</param>
        /// <returns>ApiResponse of Dictionary&lt;string, string&gt;</returns>
        ApiResponse<Dictionary<string, string>> GetNodeAclWithHttpInfo (string rkNodeId);
        /// <summary>
        ...
        /// <returns>List&lt;NodeGroupPath&gt;</returns>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns>ApiResponse of List&lt;NodeGroupPath&gt;</returns>
        ApiResponse<List<NodeGroupPath>> GetNodeParentGroupsWithHttpInfo (string rkNodeId);
        /// <summary>
        /// Search nodes
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<Node>> GetNodesWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> oid = null, List<string> name = null, List<string> subName = null, List<string> icName = null, List<string> description = null, List<string> subDescription = null, List<string> make = null, List<string> model = null, List<string> version = null, List<string> licensedFeature = null, List<string> maxSeverity = null, List<string> elementCount = null, bool? hasFailures = null, List<string> lastCheck = null, bool? isDisabled = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, List<string> type = null, List<string> lastRegistration = null, List<string> rmiHost = null, List<string> rmiPort = null, bool? auditEnabled = null, bool? eventGeneratorInstalled = null, bool? eventGeneratorEnabled = null, bool? realTimeEnabled = null, List<string> agentVersion = null, List<string> proxyHost = null, List<string> proxyPort = null, bool? isSocksProxy = null, List<string> commonAgentUuid = null, List<string> commonAgentOsName = null, List<string> commonAgentOsVersion = null, List<string> commonAgentVersion = null, List<string> commonAgentCapabilities = null, List<string> macAddress = null, List<string> ipAddress = null, List<string> tag = null, List<string> customProperty = null, string importedTimeRange = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Dictionary<string, string>> CreateNodeAclAsync (string rkNodeId, Object body);
        ...
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, string>>> CreateNodeAclAsyncWithHttpInfo (string rkNodeId, Object body);
        /// <summary>
        /// Delete a custom property type (since 1.6)
        /// </summary>
        /// <remarks>
        ...
        /// <param name="rkNodeId">ID of Node to fetch the ACL</param>
        /// <returns>Task of Dictionary&lt;string, string&gt;</returns>
        System.Threading.Tasks.Task<Dictionary<string, string>> GetNodeAclAsync (string rkNodeId);
        ...
        /// <param name="rkNodeId">ID of Node to fetch the ACL</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, string&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, string>>> GetNodeAclAsyncWithHttpInfo (string rkNodeId);
        /// <summary>
        /// Get node details by ID
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns>Task of List&lt;NodeGroupPath&gt;</returns>
        System.Threading.Tasks.Task<List<NodeGroupPath>> GetNodeParentGroupsAsync (string rkNodeId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns>Task of ApiResponse (List&lt;NodeGroupPath&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<NodeGroupPath>>> GetNodeParentGroupsAsyncWithHttpInfo (string rkNodeId);
        /// <summary>
        /// Search nodes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<Node>> GetNodesAsync (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> oid = null, List<string> name = null, List<string> subName = null, List<string> icName = null, List<string> description = null, List<string> subDescription = null, List<string> make = null, List<string> model = null, List<string> version = null, List<string> licensedFeature = null, List<string> maxSeverity = null, List<string> elementCount = null, bool? hasFailures = null, List<string> lastCheck = null, bool? isDisabled = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, List<string> type = null, List<string> lastRegistration = null, List<string> rmiHost = null, List<string> rmiPort = null, bool? auditEnabled = null, bool? eventGeneratorInstalled = null, bool? eventGeneratorEnabled = null, bool? realTimeEnabled = null, List<string> agentVersion = null, List<string> proxyHost = null, List<string> proxyPort = null, bool? isSocksProxy = null, List<string> commonAgentUuid = null, List<string> commonAgentOsName = null, List<string> commonAgentOsVersion = null, List<string> commonAgentVersion = null, List<string> commonAgentCapabilities = null, List<string> macAddress = null, List<string> ipAddress = null, List<string> tag = null, List<string> customProperty = null, string importedTimeRange = null);
    ...
    public partial class NodesApi : INodesApi
    {
        ...
        /// <summary>
        /// Post a new node access control list Replaces the access control list for a node with the new submitted set of entries.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of node to fetch the ACL</param>
        /// <param name="body">ACL - Map of user or user group IDs to role IDs</param>
        /// <returns>Dictionary&lt;string, string&gt;</returns>
        public Dictionary<string, string> CreateNodeAcl (string rkNodeId, Object body)
        {
             ApiResponse<Dictionary<string, string>> localVarResponse = CreateNodeAclWithHttpInfo(rkNodeId, body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">ACL - Map of user or user group IDs to role IDs</param>
        /// <returns>ApiResponse of Dictionary&lt;string, string&gt;</returns>
        public ApiResponse< Dictionary<string, string> > CreateNodeAclWithHttpInfo (string rkNodeId, Object body)
        {
        ...
        /// <param name="body">ACL - Map of user or user group IDs to role IDs</param>
        /// <returns>Task of Dictionary&lt;string, string&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, string>> CreateNodeAclAsync (string rkNodeId, Object body)
        {
             ApiResponse<Dictionary<string, string>> localVarResponse = await CreateNodeAclAsyncWithHttpInfo(rkNodeId, body);
             return localVarResponse.Data;
        ...
        /// <param name="body">ACL - Map of user or user group IDs to role IDs</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, string&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Dictionary<string, string>>> CreateNodeAclAsyncWithHttpInfo (string rkNodeId, Object body)
        {
            // verify the required parameter 'rkNodeId' is set
            if (rkNodeId == null)
                throw new ApiException(400, "Missing required parameter 'rkNodeId' when calling NodesApi->CreateNodeAcl");
        ...
        /// <summary>
        /// Retire a node by removing all node licenses allocated to it Permissions needed: &#39;tool.node.load&#39;
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of node to delete</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get node access control list Returns the access control list for the specified node.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of Node to fetch the ACL</param>
        /// <returns>Dictionary&lt;string, string&gt;</returns>
        public Dictionary<string, string> GetNodeAcl (string rkNodeId)
        {
             ApiResponse<Dictionary<string, string>> localVarResponse = GetNodeAclWithHttpInfo(rkNodeId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="rkNodeId">ID of Node to fetch the ACL</param>
        /// <returns>ApiResponse of Dictionary&lt;string, string&gt;</returns>
        public ApiResponse< Dictionary<string, string> > GetNodeAclWithHttpInfo (string rkNodeId)
        {
            // verify the required parameter 'rkNodeId' is set
            if (rkNodeId == null)
        ...
        /// <param name="rkNodeId">ID of Node to fetch the ACL</param>
        /// <returns>Task of Dictionary&lt;string, string&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, string>> GetNodeAclAsync (string rkNodeId)
        {
             ApiResponse<Dictionary<string, string>> localVarResponse = await GetNodeAclAsyncWithHttpInfo(rkNodeId);
             return localVarResponse.Data;
        ...
        /// <param name="rkNodeId">ID of Node to fetch the ACL</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, string&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Dictionary<string, string>>> GetNodeAclAsyncWithHttpInfo (string rkNodeId)
        {
            // verify the required parameter 'rkNodeId' is set
            if (rkNodeId == null)
                throw new ApiException(400, "Missing required parameter 'rkNodeId' when calling NodesApi->GetNodeAcl");
        ...
        /// <summary>
        /// Get node details by ID Returns the details of a single node.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of node to fetch</param>
        /// <returns>Node</returns>
        ...
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns>List&lt;NodeGroupPath&gt;</returns>
        public List<NodeGroupPath> GetNodeParentGroups (string rkNodeId)
        {
             ApiResponse<List<NodeGroupPath>> localVarResponse = GetNodeParentGroupsWithHttpInfo(rkNodeId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns>ApiResponse of List&lt;NodeGroupPath&gt;</returns>
        public ApiResponse< List<NodeGroupPath> > GetNodeParentGroupsWithHttpInfo (string rkNodeId)
        {
            // verify the required parameter 'rkNodeId' is set
            if (rkNodeId == null)
            ...
            return new ApiResponse<List<NodeGroupPath>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<NodeGroupPath>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<NodeGroupPath>)));
        }
        ...
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns>Task of List&lt;NodeGroupPath&gt;</returns>
        public async System.Threading.Tasks.Task<List<NodeGroupPath>> GetNodeParentGroupsAsync (string rkNodeId)
        {
             ApiResponse<List<NodeGroupPath>> localVarResponse = await GetNodeParentGroupsAsyncWithHttpInfo(rkNodeId);
             return localVarResponse.Data;
        ...
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns>Task of ApiResponse (List&lt;NodeGroupPath&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<NodeGroupPath>>> GetNodeParentGroupsAsyncWithHttpInfo (string rkNodeId)
        {
            // verify the required parameter 'rkNodeId' is set
            if (rkNodeId == null)
                throw new ApiException(400, "Missing required parameter 'rkNodeId' when calling NodesApi->GetNodeParentGroups");
        ...
        /// <summary>
        /// Search nodes Returns a list of all nodes or those that match the provided filter criteria. Nodes that the user does not have access to will be omitted from the search results. Filtering for nodes by ip-address only works for agent nodes, because the ip-addresses for other node types are not persisted.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pageLimit">Page limit for paging support (optional)</param>
        /// <param name="pageStart">Page start for paging support (optional)</param>
        ...
        {
             ApiResponse<List<Node>> localVarResponse = GetNodesWithHttpInfo(pageLimit, pageStart, id, oid, name, subName, icName, description, subDescription, make, model, version, licensedFeature, maxSeverity, elementCount, hasFailures, lastCheck, isDisabled, modifiedTime, importedTime, trackingId, type, lastRegistration, rmiHost, rmiPort, auditEnabled, eventGeneratorInstalled, eventGeneratorEnabled, realTimeEnabled, agentVersion, proxyHost, proxyPort, isSocksProxy, commonAgentUuid, commonAgentOsName, commonAgentOsVersion, commonAgentVersion, commonAgentCapabilities, macAddress, ipAddress, tag, customProperty, importedTimeRange);
             return localVarResponse.Data;
        }
        ...
        /// <param name="importedTimeRange">Imported time range of nodes to fetch (optional)</param>
        /// <returns>ApiResponse of List&lt;Node&gt;</returns>
        public ApiResponse< List<Node> > GetNodesWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> oid = null, List<string> name = null, List<string> subName = null, List<string> icName = null, List<string> description = null, List<string> subDescription = null, List<string> make = null, List<string> model = null, List<string> version = null, List<string> licensedFeature = null, List<string> maxSeverity = null, List<string> elementCount = null, bool? hasFailures = null, List<string> lastCheck = null, bool? isDisabled = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, List<string> type = null, List<string> lastRegistration = null, List<string> rmiHost = null, List<string> rmiPort = null, bool? auditEnabled = null, bool? eventGeneratorInstalled = null, bool? eventGeneratorEnabled = null, bool? realTimeEnabled = null, List<string> agentVersion = null, List<string> proxyHost = null, List<string> proxyPort = null, bool? isSocksProxy = null, List<string> commonAgentUuid = null, List<string> commonAgentOsName = null, List<string> commonAgentOsVersion = null, List<string> commonAgentVersion = null, List<string> commonAgentCapabilities = null, List<string> macAddress = null, List<string> ipAddress = null, List<string> tag = null, List<string> customProperty = null, string importedTimeRange = null)
        {
        ...
        public async System.Threading.Tasks.Task<List<Node>> GetNodesAsync (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> oid = null, List<string> name = null, List<string> subName = null, List<string> icName = null, List<string> description = null, List<string> subDescription = null, List<string> make = null, List<string> model = null, List<string> version = null, List<string> licensedFeature = null, List<string> maxSeverity = null, List<string> elementCount = null, bool? hasFailures = null, List<string> lastCheck = null, bool? isDisabled = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, List<string> type = null, List<string> lastRegistration = null, List<string> rmiHost = null, List<string> rmiPort = null, bool? auditEnabled = null, bool? eventGeneratorInstalled = null, bool? eventGeneratorEnabled = null, bool? realTimeEnabled = null, List<string> agentVersion = null, List<string> proxyHost = null, List<string> proxyPort = null, bool? isSocksProxy = null, List<string> commonAgentUuid = null, List<string> commonAgentOsName = null, List<string> commonAgentOsVersion = null, List<string> commonAgentVersion = null, List<string> commonAgentCapabilities = null, List<string> macAddress = null, List<string> ipAddress = null, List<string> tag = null, List<string> customProperty = null, string importedTimeRange = null)
        {
             ApiResponse<List<Node>> localVarResponse = await GetNodesAsyncWithHttpInfo(pageLimit, pageStart, id, oid, name, subName, icName, description, subDescription, make, model, version, licensedFeature, maxSeverity, elementCount, hasFailures, lastCheck, isDisabled, modifiedTime, importedTime, trackingId, type, lastRegistration, rmiHost, rmiPort, auditEnabled, eventGeneratorInstalled, eventGeneratorEnabled, realTimeEnabled, agentVersion, proxyHost, proxyPort, isSocksProxy, commonAgentUuid, commonAgentOsName, commonAgentOsVersion, commonAgentVersion, commonAgentCapabilities, macAddress, ipAddress, tag, customProperty, importedTimeRange);
             return localVarResponse.Data;
        ...
        /// <summary>
        /// Restart Agents to bring them back in sync with the TE Server Permissions needed: &#39;tool.node.load&#39;
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">List of IDs of nodes to restart (optional)</param>
        /// <returns>NodeRestartResult</returns>
        ...
        /// <summary>
        /// Unregister an Axon agent from the server node Clears all Axon agent registration data attached to the server node. All subsequent usage of the node will attempt to interact with the Java based agent.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of the node</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Update a node Modifies a node updating the provided fields with new values. Read-only fields are ignored.&lt;br /&gt;Licenses are restricted by node type, and can be applied as follows:&lt;br /&gt; * Agents:    * FSI    * FSI-Policy    * FSI-Remediation  * Database Servers:   * DBI   * DBI-Policy * Directory Servers:   * DSI   * DSI-Policy * Network Devices:   * TWROUTER   * TWROUTER-Policy * VMWare:   * VMWare-ESX   * VMWare-ESX-Policy &lt;br /&gt;&lt;br /&gt; See endpoint GET /api/v1/settings/licenses for a listing of feature names to product display names.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkNodeId">ID of node to be updated</param>
        /// <param name="body">Node description to update the existing node</param>
