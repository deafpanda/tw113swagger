...
namespace IO.Swagger.Api
{
    ...
    public interface IPoliciesApi : IApiAccessor
    {
        ...
        ApiResponse<List<string>> GetIncludedNodesWithHttpInfo (string rkPolicyId);
        /// <summary>
        /// Search policies
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<Policy>> GetPoliciesWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, bool? purgeOldData = null, List<string> purgeDataOlderThanDays = null, List<string> nodeScope = null, string importedTimeRange = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<List<string>> GetIncludedNodesAsync (string rkPolicyId);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<string>>> GetIncludedNodesAsyncWithHttpInfo (string rkPolicyId);
        /// <summary>
        /// Search policies
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<Policy>> GetPoliciesAsync (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, bool? purgeOldData = null, List<string> purgeDataOlderThanDays = null, List<string> nodeScope = null, string importedTimeRange = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Policy>>> GetPoliciesAsyncWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, bool? purgeOldData = null, List<string> purgeDataOlderThanDays = null, List<string> nodeScope = null, string importedTimeRange = null);
        /// <summary>
        /// Get policy details by ID
        /// </summary>
        /// <remarks>
    ...
    public partial class PoliciesApi : IPoliciesApi
    {
        ...
        /// <param name="rkPolicyId">ID of policy to fetch</param>
        /// <returns>List&lt;string&gt;</returns>
        public List<string> GetIncludedNodes (string rkPolicyId)
        {
             ApiResponse<List<string>> localVarResponse = GetIncludedNodesWithHttpInfo(rkPolicyId);
        ...
        /// <param name="rkPolicyId">ID of policy to fetch</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public ApiResponse< List<string> > GetIncludedNodesWithHttpInfo (string rkPolicyId)
        {
            // verify the required parameter 'rkPolicyId' is set
            if (rkPolicyId == null)
        ...
        /// <param name="rkPolicyId">ID of policy to fetch</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<List<string>> GetIncludedNodesAsync (string rkPolicyId)
        {
             ApiResponse<List<string>> localVarResponse = await GetIncludedNodesAsyncWithHttpInfo(rkPolicyId);
             return localVarResponse.Data;
        ...
        /// <param name="rkPolicyId">ID of policy to fetch</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<string>>> GetIncludedNodesAsyncWithHttpInfo (string rkPolicyId)
        {
            // verify the required parameter 'rkPolicyId' is set
            if (rkPolicyId == null)
                throw new ApiException(400, "Missing required parameter 'rkPolicyId' when calling PoliciesApi->GetIncludedNodes");
        ...
        /// <summary>
        /// Search policies Returns a list of all policies or those that match the provided filter criteria.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pageLimit">Page limit for paging support (optional)</param>
        /// <param name="pageStart">Page start for paging support (optional)</param>
        ...
        /// <param name="importedTimeRange">Imported time range of policy to fetch (optional)</param>
        /// <returns>List&lt;Policy&gt;</returns>
        public List<Policy> GetPolicies (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, bool? purgeOldData = null, List<string> purgeDataOlderThanDays = null, List<string> nodeScope = null, string importedTimeRange = null)
        {
             ApiResponse<List<Policy>> localVarResponse = GetPoliciesWithHttpInfo(pageLimit, pageStart, id, name, description, subDescription, modifiedTime, importedTime, trackingId, purgeOldData, purgeDataOlderThanDays, nodeScope, importedTimeRange);
             return localVarResponse.Data;
        }
        ...
        /// <param name="importedTimeRange">Imported time range of policy to fetch (optional)</param>
        /// <returns>ApiResponse of List&lt;Policy&gt;</returns>
        public ApiResponse< List<Policy> > GetPoliciesWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, bool? purgeOldData = null, List<string> purgeDataOlderThanDays = null, List<string> nodeScope = null, string importedTimeRange = null)
        {
        ...
        {
             ApiResponse<List<Policy>> localVarResponse = await GetPoliciesAsyncWithHttpInfo(pageLimit, pageStart, id, name, description, subDescription, modifiedTime, importedTime, trackingId, purgeOldData, purgeDataOlderThanDays, nodeScope, importedTimeRange);
             return localVarResponse.Data;
        ...
        /// <param name="importedTimeRange">Imported time range of policy to fetch (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;Policy&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Policy>>> GetPoliciesAsyncWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, List<string> modifiedTime = null, List<string> importedTime = null, List<string> trackingId = null, bool? purgeOldData = null, List<string> purgeDataOlderThanDays = null, List<string> nodeScope = null, string importedTimeRange = null)
        {
        ...
        /// <summary>
        /// Get policy details by ID Returns the details of a single policy.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkPolicyId">ID of policy to fetch</param>
        /// <returns>Policy</returns>
        ...
        /// <summary>
        /// Post a request to run policies Allows evaluation of policy test criteria against previously harvested element versions for a specified set of policies and nodes. This does not harvest state from monitored hosts.   Use this after updating or importing policy content to refresh policy test results.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">List of Policies and list of Nodes where Policies should be run. List of Nodes is optional. (optional)</param>
        /// <returns></returns>
