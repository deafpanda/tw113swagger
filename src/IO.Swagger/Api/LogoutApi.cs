...
namespace IO.Swagger.Api
{
    ...
    public partial class LogoutApi : ILogoutApi
    {
        ...
        /// <returns></returns>
        public LogoutApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Logout of aï¿½session (since 1.13) Invalidates the current session, allowing clients to cleanup.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns></returns>
        public void Logout ()
