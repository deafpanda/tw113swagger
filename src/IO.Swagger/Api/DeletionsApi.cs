...
namespace IO.Swagger.Api
{
    ...
    public interface IDeletionsApi : IApiAccessor
    {
        ...
        /// <returns>List&lt;DeletionRecord&gt;</returns>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="deletedTimeRange">Time range of deletion records to fetch (optional)</param>
        /// <returns>ApiResponse of List&lt;DeletionRecord&gt;</returns>
        ApiResponse<List<DeletionRecord>> GetAllWithHttpInfo (string deletedTimeRange = null);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="deletedTimeRange">Time range of deletion records to fetch (optional)</param>
        /// <returns>Task of List&lt;DeletionRecord&gt;</returns>
        System.Threading.Tasks.Task<List<DeletionRecord>> GetAllAsync (string deletedTimeRange = null);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="deletedTimeRange">Time range of deletion records to fetch (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;DeletionRecord&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<DeletionRecord>>> GetAllAsyncWithHttpInfo (string deletedTimeRange = null);
    ...
    public partial class DeletionsApi : IDeletionsApi
    {
        ...
        /// <param name="deletedTimeRange">Time range of deletion records to fetch (optional)</param>
        /// <returns>List&lt;DeletionRecord&gt;</returns>
        public List<DeletionRecord> GetAll (string deletedTimeRange = null)
        {
             ApiResponse<List<DeletionRecord>> localVarResponse = GetAllWithHttpInfo(deletedTimeRange);
        ...
        /// <param name="deletedTimeRange">Time range of deletion records to fetch (optional)</param>
        /// <returns>ApiResponse of List&lt;DeletionRecord&gt;</returns>
        public ApiResponse< List<DeletionRecord> > GetAllWithHttpInfo (string deletedTimeRange = null)
        {
            ...
            return new ApiResponse<List<DeletionRecord>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<DeletionRecord>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<DeletionRecord>)));
        }
        ...
        /// <param name="deletedTimeRange">Time range of deletion records to fetch (optional)</param>
        /// <returns>Task of List&lt;DeletionRecord&gt;</returns>
        public async System.Threading.Tasks.Task<List<DeletionRecord>> GetAllAsync (string deletedTimeRange = null)
        {
             ApiResponse<List<DeletionRecord>> localVarResponse = await GetAllAsyncWithHttpInfo(deletedTimeRange);
             return localVarResponse.Data;
        ...
        /// <param name="deletedTimeRange">Time range of deletion records to fetch (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;DeletionRecord&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DeletionRecord>>> GetAllAsyncWithHttpInfo (string deletedTimeRange = null)
        {
