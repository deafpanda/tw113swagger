...
namespace IO.Swagger.Api
{
    ...
    public interface IVersionsApi : IApiAccessor
    {
        ...
        /// <returns>List&lt;AuditInfo&gt;</returns>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">rkVersionId to fetch</param>
        /// <returns>ApiResponse of List&lt;AuditInfo&gt;</returns>
        ApiResponse<List<AuditInfo>> GetAuditDataByReadableKeyVersionIdWithHttpInfo (string rkVersionId);
        /// <summary>
        ...
        /// <returns>Dictionary&lt;string, ValueTypeAttribute&gt;</returns>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">ID of element version attributes to fetch</param>
        /// <returns>ApiResponse of Dictionary&lt;string, ValueTypeAttribute&gt;</returns>
        ApiResponse<Dictionary<string, ValueTypeAttribute>> GetElementVersionAttributesWithHttpInfo (string rkVersionId);
        /// <summary>
        ...
        /// <returns>List&lt;ElementVersionWithAttributes&gt;</returns>
        ...
        /// <param name="timeReceivedRange">Time received range of element versions to fetch. (optional)</param>
        /// <param name="previousId">When paging, this should be the last element version id returned by the previous page (optional)</param>
        /// <returns>ApiResponse of List&lt;ElementVersionWithAttributes&gt;</returns>
        ApiResponse<List<ElementVersionWithAttributes>> GetElementVersionsExtractWithHttpInfo (string pageLimit = null, string timeDetectedRange = null, string timeReceivedRange = null, string previousId = null);
        /// <summary>
        ...
        /// <param name="elementName">Elements names of elements versions to fetch. (optional)</param>
        ...
        /// <param name="hash">Possible hash values (md5, sha1, sha256, sha512) of elements versions to fetch. (optional)</param>
        /// <param name="timeDetectedRange">Time detected range of element versions to fetch. (optional)</param>
        /// <param name="timeReceivedRange">Time received range of element versions to fetch. (optional)</param>
        ...
        /// <returns>List&lt;ElementVersion&gt;</returns>
        ...
        /// <param name="isPromoted">True if the element version has been promoted. (optional)</param>
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>ApiResponse of List&lt;ElementVersion&gt;</returns>
        ApiResponse<List<ElementVersion>> GetHistoricalElementVersionsWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, string at = null, bool? isPromoted = null, string severityRange = null);
        /// <summary>
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>ApiResponse of List&lt;ElementVersion&gt;</returns>
        ApiResponse<List<ElementVersion>> GetLatestElementVersionsWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, bool? isPromoted = null, string severityRange = null);
        /// <summary>
        ...
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>ApiResponse of CreateVersionRequest</returns>
        ApiResponse<CreateVersionRequest> GetPromoteRequestByIdWithHttpInfo (string requestId);
        /// <summary>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">rkVersionId to fetch</param>
        /// <returns>Task of List&lt;AuditInfo&gt;</returns>
        System.Threading.Tasks.Task<List<AuditInfo>> GetAuditDataByReadableKeyVersionIdAsync (string rkVersionId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">rkVersionId to fetch</param>
        /// <returns>Task of ApiResponse (List&lt;AuditInfo&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<AuditInfo>>> GetAuditDataByReadableKeyVersionIdAsyncWithHttpInfo (string rkVersionId);
        /// <summary>
        /// Get updated state of element version change requests
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">ID of element version attributes to fetch</param>
        /// <returns>Task of Dictionary&lt;string, ValueTypeAttribute&gt;</returns>
        System.Threading.Tasks.Task<Dictionary<string, ValueTypeAttribute>> GetElementVersionAttributesAsync (string rkVersionId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">ID of element version attributes to fetch</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, ValueTypeAttribute&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, ValueTypeAttribute>>> GetElementVersionAttributesAsyncWithHttpInfo (string rkVersionId);
        /// <summary>
        /// Get element version content by ID
        /// </summary>
        /// <remarks>
        ...
        /// <param name="timeReceivedRange">Time received range of element versions to fetch. (optional)</param>
        /// <param name="previousId">When paging, this should be the last element version id returned by the previous page (optional)</param>
        /// <returns>Task of List&lt;ElementVersionWithAttributes&gt;</returns>
        System.Threading.Tasks.Task<List<ElementVersionWithAttributes>> GetElementVersionsExtractAsync (string pageLimit = null, string timeDetectedRange = null, string timeReceivedRange = null, string previousId = null);
        ...
        /// <param name="timeReceivedRange">Time received range of element versions to fetch. (optional)</param>
        /// <param name="previousId">When paging, this should be the last element version id returned by the previous page (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ElementVersionWithAttributes&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ElementVersionWithAttributes>>> GetElementVersionsExtractAsyncWithHttpInfo (string pageLimit = null, string timeDetectedRange = null, string timeReceivedRange = null, string previousId = null);
        /// <summary>
        /// Search all element versions
        /// </summary>
        /// <remarks>
        ...
        /// <param name="isPromoted">True if the element version has been promoted. (optional)</param>
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>Task of List&lt;ElementVersion&gt;</returns>
        System.Threading.Tasks.Task<List<ElementVersion>> GetHistoricalElementVersionsAsync (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, string at = null, bool? isPromoted = null, string severityRange = null);
        ...
        /// <param name="isPromoted">True if the element version has been promoted. (optional)</param>
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ElementVersion&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ElementVersion>>> GetHistoricalElementVersionsAsyncWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, string at = null, bool? isPromoted = null, string severityRange = null);
        /// <summary>
        /// Search for latest element versions only
        /// </summary>
        /// <remarks>
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>Task of List&lt;ElementVersion&gt;</returns>
        System.Threading.Tasks.Task<List<ElementVersion>> GetLatestElementVersionsAsync (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, bool? isPromoted = null, string severityRange = null);
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ElementVersion&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ElementVersion>>> GetLatestElementVersionsAsyncWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, bool? isPromoted = null, string severityRange = null);
        /// <summary>
        /// Get promote request status (since 1.11)
        /// </summary>
        /// <remarks>
        ...
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>Task of CreateVersionRequest</returns>
        System.Threading.Tasks.Task<CreateVersionRequest> GetPromoteRequestByIdAsync (string requestId);
        ...
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>Task of ApiResponse (CreateVersionRequest)</returns>
        System.Threading.Tasks.Task<ApiResponse<CreateVersionRequest>> GetPromoteRequestByIdAsyncWithHttpInfo (string requestId);
        /// <summary>
        /// Request promotion of a set of element versions (since 1.11)
        /// </summary>
        /// <remarks>
    ...
    public partial class VersionsApi : IVersionsApi
    {
        ...
        /// <summary>
        /// Request processing submitted change events for External Rules Queues the processing of change events for a Node and External Rule. Changes are processed by any actions and policy tests that are scoped appropriately. Processing is asynchronous. The request will return to the caller once the input has been validated. The result can be queried at /api/v1/versions/changeRequests/{rkChangeRequestId}. Version descriptions with the exists field set or defaulting to true must have one of the MD5, SHA-1, SHA-256 or SHA-512 hash attributes set. If no hash attribute is set, an MD5 hash will be computed for you based on the value of the content field, including when the content field is empty, null, or unspecified. When the exists field is set to false, then content and attributes fields must not be specified. Data submitted by the TE REST API is subject to XSS filtering. To provide literal value for the content of an element version, base64 encode the data, and submit that in the &#39;contentBase64&#39; field instead of the &#39;content&#39; field.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Version creation request to be executed</param>
        /// <returns>CreateVersionRequest</returns>
        ...
        /// <summary>
        /// Get audit event data for an element version Lists all associated audit data in the form of the usernames and process names that correspond to an element version.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">rkVersionId to fetch</param>
        /// <returns>List&lt;AuditInfo&gt;</returns>
        public List<AuditInfo> GetAuditDataByReadableKeyVersionId (string rkVersionId)
        {
             ApiResponse<List<AuditInfo>> localVarResponse = GetAuditDataByReadableKeyVersionIdWithHttpInfo(rkVersionId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="rkVersionId">rkVersionId to fetch</param>
        /// <returns>ApiResponse of List&lt;AuditInfo&gt;</returns>
        public ApiResponse< List<AuditInfo> > GetAuditDataByReadableKeyVersionIdWithHttpInfo (string rkVersionId)
        {
            // verify the required parameter 'rkVersionId' is set
            if (rkVersionId == null)
            ...
            return new ApiResponse<List<AuditInfo>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<AuditInfo>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<AuditInfo>)));
        }
        ...
        /// <param name="rkVersionId">rkVersionId to fetch</param>
        /// <returns>Task of List&lt;AuditInfo&gt;</returns>
        public async System.Threading.Tasks.Task<List<AuditInfo>> GetAuditDataByReadableKeyVersionIdAsync (string rkVersionId)
        {
             ApiResponse<List<AuditInfo>> localVarResponse = await GetAuditDataByReadableKeyVersionIdAsyncWithHttpInfo(rkVersionId);
             return localVarResponse.Data;
        ...
        /// <param name="rkVersionId">rkVersionId to fetch</param>
        /// <returns>Task of ApiResponse (List&lt;AuditInfo&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<AuditInfo>>> GetAuditDataByReadableKeyVersionIdAsyncWithHttpInfo (string rkVersionId)
        {
            // verify the required parameter 'rkVersionId' is set
            if (rkVersionId == null)
                throw new ApiException(400, "Missing required parameter 'rkVersionId' when calling VersionsApi->GetAuditDataByReadableKeyVersionId");
        ...
        /// <summary>
        /// Get updated state of element version change requests Returns the element version change request with current status.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>CreateVersionRequest</returns>
        ...
        /// <summary>
        /// Get element version attributes by ID Returns the attributes map for an element version with a specific ID.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">ID of element version attributes to fetch</param>
        /// <returns>Dictionary&lt;string, ValueTypeAttribute&gt;</returns>
        public Dictionary<string, ValueTypeAttribute> GetElementVersionAttributes (string rkVersionId)
        {
             ApiResponse<Dictionary<string, ValueTypeAttribute>> localVarResponse = GetElementVersionAttributesWithHttpInfo(rkVersionId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="rkVersionId">ID of element version attributes to fetch</param>
        /// <returns>ApiResponse of Dictionary&lt;string, ValueTypeAttribute&gt;</returns>
        public ApiResponse< Dictionary<string, ValueTypeAttribute> > GetElementVersionAttributesWithHttpInfo (string rkVersionId)
        {
            // verify the required parameter 'rkVersionId' is set
            if (rkVersionId == null)
            ...
            return new ApiResponse<Dictionary<string, ValueTypeAttribute>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (Dictionary<string, ValueTypeAttribute>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Dictionary<string, ValueTypeAttribute>)));
        }
        ...
        /// <param name="rkVersionId">ID of element version attributes to fetch</param>
        /// <returns>Task of Dictionary&lt;string, ValueTypeAttribute&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, ValueTypeAttribute>> GetElementVersionAttributesAsync (string rkVersionId)
        {
             ApiResponse<Dictionary<string, ValueTypeAttribute>> localVarResponse = await GetElementVersionAttributesAsyncWithHttpInfo(rkVersionId);
             return localVarResponse.Data;
        ...
        /// <param name="rkVersionId">ID of element version attributes to fetch</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, ValueTypeAttribute&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Dictionary<string, ValueTypeAttribute>>> GetElementVersionAttributesAsyncWithHttpInfo (string rkVersionId)
        {
            // verify the required parameter 'rkVersionId' is set
            if (rkVersionId == null)
                throw new ApiException(400, "Missing required parameter 'rkVersionId' when calling VersionsApi->GetElementVersionAttributes");
        ...
        /// <summary>
        /// Get element version content by ID Returns the archived content data for the given element version. Binary content is not supported.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">ID of element version details to fetch</param>
        /// <param name="sizeLimit">Fail if content size exceeds this limit of size in bytes. (optional)</param>
        ...
        /// <summary>
        /// Get element version details by ID Returns an element version with a specific ID.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkVersionId">ID of element version details to fetch</param>
        /// <returns>ElementVersion</returns>
        ...
        /// <param name="previousId">When paging, this should be the last element version id returned by the previous page (optional)</param>
        /// <returns>List&lt;ElementVersionWithAttributes&gt;</returns>
        public List<ElementVersionWithAttributes> GetElementVersionsExtract (string pageLimit = null, string timeDetectedRange = null, string timeReceivedRange = null, string previousId = null)
        {
             ApiResponse<List<ElementVersionWithAttributes>> localVarResponse = GetElementVersionsExtractWithHttpInfo(pageLimit, timeDetectedRange, timeReceivedRange, previousId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="previousId">When paging, this should be the last element version id returned by the previous page (optional)</param>
        /// <returns>ApiResponse of List&lt;ElementVersionWithAttributes&gt;</returns>
        public ApiResponse< List<ElementVersionWithAttributes> > GetElementVersionsExtractWithHttpInfo (string pageLimit = null, string timeDetectedRange = null, string timeReceivedRange = null, string previousId = null)
        {
            ...
            return new ApiResponse<List<ElementVersionWithAttributes>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<ElementVersionWithAttributes>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<ElementVersionWithAttributes>)));
        }
        ...
        /// <param name="previousId">When paging, this should be the last element version id returned by the previous page (optional)</param>
        /// <returns>Task of List&lt;ElementVersionWithAttributes&gt;</returns>
        public async System.Threading.Tasks.Task<List<ElementVersionWithAttributes>> GetElementVersionsExtractAsync (string pageLimit = null, string timeDetectedRange = null, string timeReceivedRange = null, string previousId = null)
        {
             ApiResponse<List<ElementVersionWithAttributes>> localVarResponse = await GetElementVersionsExtractAsyncWithHttpInfo(pageLimit, timeDetectedRange, timeReceivedRange, previousId);
             return localVarResponse.Data;
        ...
        /// <param name="previousId">When paging, this should be the last element version id returned by the previous page (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ElementVersionWithAttributes&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ElementVersionWithAttributes>>> GetElementVersionsExtractAsyncWithHttpInfo (string pageLimit = null, string timeDetectedRange = null, string timeReceivedRange = null, string previousId = null)
        {
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>List&lt;ElementVersion&gt;</returns>
        public List<ElementVersion> GetHistoricalElementVersions (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, string at = null, bool? isPromoted = null, string severityRange = null)
        {
             ApiResponse<List<ElementVersion>> localVarResponse = GetHistoricalElementVersionsWithHttpInfo(pageLimit, pageStart, id, elementName, nodeLabel, ruleName, elementId, nodeId, ruleId, baselineVersion, changeType, exists, severity, timeDetected, timeReceived, promotionComment, approvalId, outsideMaintenanceWindow, scanId, md5, sha1, sha256, sha512, hash, timeDetectedRange, timeReceivedRange, at, isPromoted, severityRange);
             return localVarResponse.Data;
        }
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>ApiResponse of List&lt;ElementVersion&gt;</returns>
        public ApiResponse< List<ElementVersion> > GetHistoricalElementVersionsWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, string at = null, bool? isPromoted = null, string severityRange = null)
        {
            ...
            return new ApiResponse<List<ElementVersion>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<ElementVersion>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<ElementVersion>)));
        }
        ...
        public async System.Threading.Tasks.Task<List<ElementVersion>> GetHistoricalElementVersionsAsync (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, string at = null, bool? isPromoted = null, string severityRange = null)
        {
             ApiResponse<List<ElementVersion>> localVarResponse = await GetHistoricalElementVersionsAsyncWithHttpInfo(pageLimit, pageStart, id, elementName, nodeLabel, ruleName, elementId, nodeId, ruleId, baselineVersion, changeType, exists, severity, timeDetected, timeReceived, promotionComment, approvalId, outsideMaintenanceWindow, scanId, md5, sha1, sha256, sha512, hash, timeDetectedRange, timeReceivedRange, at, isPromoted, severityRange);
             return localVarResponse.Data;
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ElementVersion&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ElementVersion>>> GetHistoricalElementVersionsAsyncWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, string at = null, bool? isPromoted = null, string severityRange = null)
        {
        ...
        /// <summary>
        /// Search for latest element versions only Returns only the most recent element version for each element that matches the search criteria. Element versions for nodes that the user does not have access to will be omitted from the search results.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pageLimit">Page limit for paging support (optional)</param>
        /// <param name="pageStart">Page start for paging support (optional)</param>
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>List&lt;ElementVersion&gt;</returns>
        public List<ElementVersion> GetLatestElementVersions (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, bool? isPromoted = null, string severityRange = null)
        {
             ApiResponse<List<ElementVersion>> localVarResponse = GetLatestElementVersionsWithHttpInfo(pageLimit, pageStart, id, elementName, nodeLabel, ruleName, elementId, nodeId, ruleId, baselineVersion, changeType, exists, severity, timeDetected, timeReceived, promotionComment, approvalId, outsideMaintenanceWindow, scanId, md5, sha1, sha256, sha512, hash, timeDetectedRange, timeReceivedRange, isPromoted, severityRange);
             return localVarResponse.Data;
        }
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>ApiResponse of List&lt;ElementVersion&gt;</returns>
        public ApiResponse< List<ElementVersion> > GetLatestElementVersionsWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, bool? isPromoted = null, string severityRange = null)
        {
        ...
        public async System.Threading.Tasks.Task<List<ElementVersion>> GetLatestElementVersionsAsync (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, bool? isPromoted = null, string severityRange = null)
        {
             ApiResponse<List<ElementVersion>> localVarResponse = await GetLatestElementVersionsAsyncWithHttpInfo(pageLimit, pageStart, id, elementName, nodeLabel, ruleName, elementId, nodeId, ruleId, baselineVersion, changeType, exists, severity, timeDetected, timeReceived, promotionComment, approvalId, outsideMaintenanceWindow, scanId, md5, sha1, sha256, sha512, hash, timeDetectedRange, timeReceivedRange, isPromoted, severityRange);
             return localVarResponse.Data;
        ...
        /// <param name="severityRange">Filter for element versions with severity in the comma separated range of values, inclusively (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;ElementVersion&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ElementVersion>>> GetLatestElementVersionsAsyncWithHttpInfo (string pageLimit = null, string pageStart = null, List<string> id = null, List<string> elementName = null, List<string> nodeLabel = null, List<string> ruleName = null, List<string> elementId = null, List<string> nodeId = null, List<string> ruleId = null, List<string> baselineVersion = null, List<string> changeType = null, bool? exists = null, List<string> severity = null, List<string> timeDetected = null, List<string> timeReceived = null, List<string> promotionComment = null, List<string> approvalId = null, bool? outsideMaintenanceWindow = null, List<string> scanId = null, List<string> md5 = null, List<string> sha1 = null, List<string> sha256 = null, List<string> sha512 = null, List<string> hash = null, string timeDetectedRange = null, string timeReceivedRange = null, bool? isPromoted = null, string severityRange = null)
        {
        ...
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>CreateVersionRequest</returns>
        public CreateVersionRequest GetPromoteRequestById (string requestId)
        {
             ApiResponse<CreateVersionRequest> localVarResponse = GetPromoteRequestByIdWithHttpInfo(requestId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>ApiResponse of CreateVersionRequest</returns>
        public ApiResponse< CreateVersionRequest > GetPromoteRequestByIdWithHttpInfo (string requestId)
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
        ...
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>Task of CreateVersionRequest</returns>
        public async System.Threading.Tasks.Task<CreateVersionRequest> GetPromoteRequestByIdAsync (string requestId)
        {
             ApiResponse<CreateVersionRequest> localVarResponse = await GetPromoteRequestByIdAsyncWithHttpInfo(requestId);
             return localVarResponse.Data;
        ...
        /// <param name="requestId">ID of command to fetch</param>
        /// <returns>Task of ApiResponse (CreateVersionRequest)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreateVersionRequest>> GetPromoteRequestByIdAsyncWithHttpInfo (string requestId)
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
                throw new ApiException(400, "Missing required parameter 'requestId' when calling VersionsApi->GetPromoteRequestById");
