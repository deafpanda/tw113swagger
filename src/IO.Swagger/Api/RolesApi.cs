...
namespace IO.Swagger.Api
{
    ...
    public interface IRolesApi : IApiAccessor
    {
        ...
        ApiResponse<List<Permission>> GetRolePermissionsWithHttpInfo (string rkRoleId);
        /// <summary>
        /// Search roles
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<Role>> GetRolesWithHttpInfo (List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, bool? builtin = null, bool? administrator = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<List<Permission>> GetRolePermissionsAsync (string rkRoleId);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Permission>>> GetRolePermissionsAsyncWithHttpInfo (string rkRoleId);
        /// <summary>
        /// Search roles
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<Role>> GetRolesAsync (List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, bool? builtin = null, bool? administrator = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Role>>> GetRolesAsyncWithHttpInfo (List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, bool? builtin = null, bool? administrator = null);
        /// <summary>
        /// Update an existing role
        /// </summary>
        /// <remarks>
    ...
    public partial class RolesApi : IRolesApi
    {
        ...
        /// <summary>
        /// Add a permission to a role Associates a Permission with a role, granting it to all users that have that Role.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkRoleId">ID of role to create the association</param>
        /// <param name="rkPermissionId">ID of permission to create the association</param>
        ...
        /// <summary>
        /// Post a new role Posts a request to create a new role.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Role object to be created in TE</param>
        /// <returns>Role</returns>
        ...
        /// <summary>
        /// Delete association between a role and a permission Removes a permission from the role, no longer granting it to users with that role.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkRoleId">ID of role to remove the association</param>
        /// <param name="rkPermissionId">ID of permission to remove the association</param>
        ...
        /// <summary>
        /// Delete a role Removes an existing role from the system.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkRoleId">ID of role to fetch</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get role details by ID Returns the details of a single role.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkRoleId">ID of role to fetch</param>
        /// <returns>Role</returns>
        ...
        /// <summary>
        /// Get the list of permissions associated with a role Returns a list that includes all the permissions that a user is granted by having the specified role.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkRoleId">ID of role to fetch the permissions from</param>
        /// <returns>List&lt;Permission&gt;</returns>
        public List<Permission> GetRolePermissions (string rkRoleId)
        {
             ApiResponse<List<Permission>> localVarResponse = GetRolePermissionsWithHttpInfo(rkRoleId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="rkRoleId">ID of role to fetch the permissions from</param>
        /// <returns>ApiResponse of List&lt;Permission&gt;</returns>
        public ApiResponse< List<Permission> > GetRolePermissionsWithHttpInfo (string rkRoleId)
        {
            // verify the required parameter 'rkRoleId' is set
            if (rkRoleId == null)
        ...
        /// <param name="rkRoleId">ID of role to fetch the permissions from</param>
        /// <returns>Task of List&lt;Permission&gt;</returns>
        public async System.Threading.Tasks.Task<List<Permission>> GetRolePermissionsAsync (string rkRoleId)
        {
             ApiResponse<List<Permission>> localVarResponse = await GetRolePermissionsAsyncWithHttpInfo(rkRoleId);
             return localVarResponse.Data;
        ...
        /// <param name="rkRoleId">ID of role to fetch the permissions from</param>
        /// <returns>Task of ApiResponse (List&lt;Permission&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Permission>>> GetRolePermissionsAsyncWithHttpInfo (string rkRoleId)
        {
            // verify the required parameter 'rkRoleId' is set
            if (rkRoleId == null)
                throw new ApiException(400, "Missing required parameter 'rkRoleId' when calling RolesApi->GetRolePermissions");
        ...
        /// <summary>
        /// Search roles Returns a list of all roles, or those that match the filter criteria.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Role IDs to search. (optional)</param>
        /// <param name="name">Role names to search. (optional)</param>
        ...
        /// <param name="administrator">Role administrator filter. (optional)</param>
        /// <returns>List&lt;Role&gt;</returns>
        public List<Role> GetRoles (List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, bool? builtin = null, bool? administrator = null)
        {
             ApiResponse<List<Role>> localVarResponse = GetRolesWithHttpInfo(id, name, description, subDescription, builtin, administrator);
             return localVarResponse.Data;
        }
        ...
        /// <param name="administrator">Role administrator filter. (optional)</param>
        /// <returns>ApiResponse of List&lt;Role&gt;</returns>
        public ApiResponse< List<Role> > GetRolesWithHttpInfo (List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, bool? builtin = null, bool? administrator = null)
        {
        ...
        /// <param name="administrator">Role administrator filter. (optional)</param>
        /// <returns>Task of List&lt;Role&gt;</returns>
        public async System.Threading.Tasks.Task<List<Role>> GetRolesAsync (List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, bool? builtin = null, bool? administrator = null)
        {
             ApiResponse<List<Role>> localVarResponse = await GetRolesAsyncWithHttpInfo(id, name, description, subDescription, builtin, administrator);
             return localVarResponse.Data;
        ...
        /// <param name="administrator">Role administrator filter. (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;Role&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Role>>> GetRolesAsyncWithHttpInfo (List<string> id = null, List<string> name = null, List<string> description = null, List<string> subDescription = null, bool? builtin = null, bool? administrator = null)
        {
        ...
        /// <summary>
        /// Update an existing role Modifies an existing role to update the submitted fields with new values. Read-only fields should not be submitted.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="rkRoleId">ID of role to be updated</param>
        /// <param name="body">Role description to update the existing role</param>
