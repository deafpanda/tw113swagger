...
namespace IO.Swagger.Model
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        /// <param name="roleId">The id of the role associated to the user.</param>
        public User(bool? builtin = false, string description = default(string), string email = default(string), string id = default(string), string lastLogin = default(string), string lastLogout = default(string), string name = default(string), string roleId = default(string))
        {
        ...
        /// <summary>
        /// The id of the role associated to the user
        /// </summary>
        /// <value>The id of the role associated to the user</value>
