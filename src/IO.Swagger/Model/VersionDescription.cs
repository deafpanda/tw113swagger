...
namespace IO.Swagger.Model
{
    ...
    public partial class VersionDescription :  IEquatable<VersionDescription>, IValidatableObject
    {
        ...
        public VersionDescription(string elementName = default(string), Dictionary<string, AttributeValue> attributes = default(Dictionary<string, AttributeValue>), string content = default(string), string contentBase64 = default(string), string changeType = default(string), bool? exists = false, int? severity = default(int?), string timeDetected = default(string))
        {
