...
namespace IO.Swagger.Model
{
    ...
    public partial class ElementVersionWithAttributes :  IEquatable<ElementVersionWithAttributes>, IValidatableObject
    {
        ...
        public ElementVersionWithAttributes(string approvalId = default(string), Dictionary<string, ValueTypeAttribute> attributes = default(Dictionary<string, ValueTypeAttribute>), List<AuditInfo> audits = default(List<AuditInfo>), string baselineVersion = default(string), string changeType = default(string), string elementId = default(string), string elementName = default(string), bool? exists = false, string id = default(string), bool? isPromoted = false, string md5 = default(string), string nodeOid = default(string), bool? outsideMaintenanceWindow = false, string promotionComment = default(string), string ruleOid = default(string), string scanId = default(string), int? severity = default(int?), string sha1 = default(string), string sha256 = default(string), string sha512 = default(string), string timeDetected = default(string), int? versionNumber = default(int?))
        {
