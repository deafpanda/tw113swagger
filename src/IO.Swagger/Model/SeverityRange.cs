...
namespace IO.Swagger.Model
{
    ...
    public partial class SeverityRange :  IEquatable<SeverityRange>, IValidatableObject
    {
        ...
        public SeverityRange(string name = default(string), int? maxSeverity = default(int?), int? minSeverity = default(int?), string description = default(string), string color = default(string))
        {
            this.Name = name;
