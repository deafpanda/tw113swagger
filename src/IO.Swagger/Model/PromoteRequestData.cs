...
namespace IO.Swagger.Model
{
    ...
    public partial class PromoteRequestData :  IEquatable<PromoteRequestData>, IValidatableObject
    {
        ...
        public PromoteRequestData(string approvalId = default(string), string comment = default(string), List<string> versionIds = default(List<string>), string customPropertyTypeId = default(string))
        {
