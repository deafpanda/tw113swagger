...
namespace IO.Swagger.Model
{
    ...
    public partial class CustomPropertyType :  IEquatable<CustomPropertyType>, IValidatableObject
    {
        ...
        public CustomPropertyType(string type = default(string), string name = default(string), string description = default(string), bool? inheritDefault = false, string defaultValue = default(string), long? minValue = default(long?), long? maxValue = default(long?), List<string> availableValues = default(List<string>), int? maxCharacters = default(int?), bool? allowMultilineValues = false, int? textEditorWidth = default(int?))
        {
