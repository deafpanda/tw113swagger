...
namespace IO.Swagger.Model
{
    ...
    public partial class Node :  IEquatable<Node>, IValidatableObject
    {
        ...
        public Node(string name = default(string), string description = default(string), bool? isDisabled = false, string rmiHost = default(string), int? rmiPort = default(int?), bool? auditEnabled = false, bool? eventGeneratorEnabled = false, bool? realTimeEnabled = false, string proxyHost = default(string), int? proxyPort = default(int?), List<string> macAddresses = default(List<string>), List<string> ipAddresses = default(List<string>), ParameterSet parameterSet = default(ParameterSet), string _delegate = default(string), int? port = default(int?), string user = default(string), string password = default(string), string oracleLoginAs = default(string), string oracleSecurityType = default(string), bool? oracleIsService = false, bool? sqlServerUseNtlmv2 = false, string sqlServerSslOptions = default(string), bool? sybaseUseSsl = false, bool? dsUseSsl = false, int? getvCenterPort = default(int?), bool? getvCenterUseSsl = false, string esxiUsername = default(string), string esxiPassword = default(string), int? consolePort = default(int?), string consoleUsername = default(string), string consolePrivateKeyFile = default(string), string consolePassword = default(string), string consoleSuPassword = default(string), TaskSchedule getvCenterSyncSchedule = default(TaskSchedule))
        {
