...
namespace IO.Swagger.Model
{
    ...
    public partial class Waiver :  IEquatable<Waiver>, IValidatableObject
    {
        ...
        public Waiver(string id = default(string), string name = default(string), string description = default(string), string policyId = default(string), string policyName = default(string), string startTime = default(string), string expiration = default(string), string grantedBy = default(string), string responsible = default(string), bool? closed = false, List<PolicyTestNodeWaiver> waivedTests = default(List<PolicyTestNodeWaiver>))
        {
            this.Id = id;
            this.Name = name;
