...
namespace IO.Swagger.Model
{
    ...
    public partial class LogMessage :  IEquatable<LogMessage>, IValidatableObject
    {
        ...
        public LogMessage(string id = default(string), string time = default(string), string level = default(string), string type = default(string), string message = default(string), string username = default(string), List<string> objects = default(List<string>))
        {
            this.Id = id;
            this.Time = time;
            this.Level = level;
