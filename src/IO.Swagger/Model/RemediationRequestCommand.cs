...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemediationRequestCommand :  IEquatable<RemediationRequestCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemediationRequestCommand" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RemediationRequestCommand() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RemediationRequestCommand" /> class.
        /// </summary>
        /// <param name="requestData">Data of the request (required).</param>
        public RemediationRequestCommand(RemediationData requestData = default(RemediationData))
        {
            // to ensure "requestData" is required (not null)
            if (requestData == null)
            {
                throw new InvalidDataException("requestData is a required property for RemediationRequestCommand and cannot be null");
            }
            else
            {
        ...
        public RemediationData RequestData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemediationRequestCommand {\n");
        ...
        {
            return this.Equals(input as RemediationRequestCommand);
        }

        /// <summary>
        /// Returns true if RemediationRequestCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of RemediationRequestCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemediationRequestCommand input)
        {
            if (input == null)
                return false;
