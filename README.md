...
- API version: 1.12.1.bmaster.r20170922182356-4e84151.b1741
- SDK version: 1.0.0
...
------------ | ------------- | ------------- | -------------
*CSRFApi* | [**GetCSRFToken**](docs/CSRFApi.md#getcsrftoken) | **GET** /csrf-token | Get CSRF token
...
*HomepagesApi* | [**GetAll**](docs/HomepagesApi.md#getall) | **GET** /homepages | Search homepages
*HomepagesApi* | [**GetHomepageById**](docs/HomepagesApi.md#gethomepagebyid) | **GET** /homepages/{rkHomepageId} | Get homepage details by ID
...
*NodegroupsApi* | [**CreateNodeGroup**](docs/NodegroupsApi.md#createnodegroup) | **POST** /nodegroups | Create a new node group
*NodegroupsApi* | [**DeleteNodeGroup**](docs/NodegroupsApi.md#deletenodegroup) | **DELETE** /nodegroups/{rkNodeGroupId} | Delete a node group
...
*NodesApi* | [**CreateNodeAcl**](docs/NodesApi.md#createnodeacl) | **POST** /nodes/{rkNodeId}/acl | Post a new node access control list
...
*NodesApi* | [**DeleteNode**](docs/NodesApi.md#deletenode) | **DELETE** /nodes/{rkNodeId} | Retire a node by removing all node licenses allocated to it
...
*NodesApi* | [**GetNodeAcl**](docs/NodesApi.md#getnodeacl) | **GET** /nodes/{rkNodeId}/acl | Get node access control list
*NodesApi* | [**GetNodeById**](docs/NodesApi.md#getnodebyid) | **GET** /nodes/{rkNodeId} | Get node details by ID
...
*NodesApi* | [**GetNodes**](docs/NodesApi.md#getnodes) | **GET** /nodes | Search nodes
...
*NodesApi* | [**RestartNodes**](docs/NodesApi.md#restartnodes) | **POST** /nodes/restart | Restart Agents to bring them back in sync with the TE Server
*NodesApi* | [**RetireNode**](docs/NodesApi.md#retirenode) | **POST** /nodes/{rkNodeId}/retire | Retire a node by removing all node licenses allocated to it
...
*NodesApi* | [**UnregisterCommonAgent**](docs/NodesApi.md#unregistercommonagent) | **POST** /nodes/{rkNodeId}/unregisterCommonAgent | Unregister an Axon agent from the server node
...
*NodesApi* | [**UpdateNode**](docs/NodesApi.md#updatenode) | **PUT** /nodes/{rkNodeId} | Update a node
*PermissionsApi* | [**GetAll**](docs/PermissionsApi.md#getall) | **GET** /permissions | Search for permissions
*PermissionsApi* | [**GetPermissionById**](docs/PermissionsApi.md#getpermissionbyid) | **GET** /permissions/{rkPermissionId} | Get permission details by Id
...
*PoliciesApi* | [**GetPolicies**](docs/PoliciesApi.md#getpolicies) | **GET** /policies | Search policies
*PoliciesApi* | [**GetPolicyById**](docs/PoliciesApi.md#getpolicybyid) | **GET** /policies/{rkPolicyId} | Get policy details by ID
*PoliciesApi* | [**RunPolicies**](docs/PoliciesApi.md#runpolicies) | **POST** /policies/run | Post a request to run policies
...
*PolicytestresultsApi* | [**GetLatestPolicyTestResults**](docs/PolicytestresultsApi.md#getlatestpolicytestresults) | **GET** /policytestresults/latest | Search the latest policy test results
*PolicytestresultsApi* | [**GetPolicyTestResultById**](docs/PolicytestresultsApi.md#getpolicytestresultbyid) | **GET** /policytestresults/{rkPolicyTestResultId} | Get policy test result details by ID
*PolicytestresultsApi* | [**GetPolicyTestResults**](docs/PolicytestresultsApi.md#getpolicytestresults) | **GET** /policytestresults | Search all policy test results
...
*PolicytestsApi* | [**GetPolicyTestById**](docs/PolicytestsApi.md#getpolicytestbyid) | **GET** /policytests/{rkPolicyTestId} | Get policy test details by ID
...
*PolicytestsApi* | [**GetPolicyTestRemediation**](docs/PolicytestsApi.md#getpolicytestremediation) | **GET** /policytests/{rkPolicyTestId}/remediation | Get remediation details of a policy test
*PolicytestsApi* | [**GetPolicyTests**](docs/PolicytestsApi.md#getpolicytests) | **GET** /policytests | Search policy tests
...
*RolesApi* | [**AssociatePermissionToRole**](docs/RolesApi.md#associatepermissiontorole) | **POST** /roles/{rkRoleId}/permissions/{rkPermissionId} | Add a permission to a role
*RolesApi* | [**CreateRole**](docs/RolesApi.md#createrole) | **POST** /roles | Post a new role
*RolesApi* | [**DeletePermissionFromRole**](docs/RolesApi.md#deletepermissionfromrole) | **DELETE** /roles/{rkRoleId}/permissions/{rkPermissionId} | Delete association between a role and a permission
*RolesApi* | [**DeleteRole**](docs/RolesApi.md#deleterole) | **DELETE** /roles/{rkRoleId} | Delete a role
*RolesApi* | [**GetRole**](docs/RolesApi.md#getrole) | **GET** /roles/{rkRoleId} | Get role details by ID
*RolesApi* | [**GetRolePermissions**](docs/RolesApi.md#getrolepermissions) | **GET** /roles/{rkRoleId}/permissions | Get the list of permissions associated with a role
*RolesApi* | [**GetRoles**](docs/RolesApi.md#getroles) | **GET** /roles | Search roles
*RolesApi* | [**UpdateRole**](docs/RolesApi.md#updaterole) | **PUT** /roles/{rkRoleId} | Update an existing role
*RulegroupsApi* | [**AssociateRuleGroupableToRuleGroup**](docs/RulegroupsApi.md#associaterulegroupabletorulegroup) | **POST** /rulegroups/{rkRuleGroupId}/links/{rkRuleGroupableId} | Add a rule group link
*RulegroupsApi* | [**CreateRuleGroup**](docs/RulegroupsApi.md#createrulegroup) | **POST** /rulegroups | Create a new rule group
*RulegroupsApi* | [**DeleteRuleGroup**](docs/RulegroupsApi.md#deleterulegroup) | **DELETE** /rulegroups/{rkRuleGroupId} | Delete a rule group
*RulegroupsApi* | [**DisassociateRuleGroupableFromRuleGroup**](docs/RulegroupsApi.md#disassociaterulegroupablefromrulegroup) | **DELETE** /rulegroups/{rkRuleGroupId}/links/{rkRuleGroupableId} | Delete a rule group link
*RulegroupsApi* | [**GetRootRuleGroup**](docs/RulegroupsApi.md#getrootrulegroup) | **GET** /rulegroups/root | Get root rule group
*RulegroupsApi* | [**GetRuleGroupById**](docs/RulegroupsApi.md#getrulegroupbyid) | **GET** /rulegroups/{rkRuleGroupId} | Get the details of a single RuleGroup
*RulegroupsApi* | [**GetRuleGroups**](docs/RulegroupsApi.md#getrulegroups) | **GET** /rulegroups | Search all RuleGroups
*RulesApi* | [**CreateExternalRule**](docs/RulesApi.md#createexternalrule) | **POST** /rules | Create a new rule
*RulesApi* | [**GetRuleById**](docs/RulesApi.md#getrulebyid) | **GET** /rules/{rkRuleId} | Get rule details by ID
...
*RulesApi* | [**GetRules**](docs/RulesApi.md#getrules) | **GET** /rules | Search rules
*RulesApi* | [**UpdateRule**](docs/RulesApi.md#updaterule) | **PUT** /rules/{rkRuleId} | Update details of a rule
...
*SettingsApi* | [**GetSystemProperties**](docs/SettingsApi.md#getsystemproperties) | **GET** /settings/systemProperties | Get JVM system properties
...
*StatusApi* | [**GetStatus**](docs/StatusApi.md#getstatus) | **GET** /status | Get TE system status information
...
*TasksApi* | [**GetTaskById**](docs/TasksApi.md#gettaskbyid) | **GET** /tasks/{rkTaskId} | Get task details by ID
...
*UserGroupsApi* | [**AssociateUserToGroup**](docs/UserGroupsApi.md#associateusertogroup) | **POST** /user-groups/{rkUserGroupId}/users/{rkUserId} | Add a user to a user group
*UserGroupsApi* | [**Create**](docs/UserGroupsApi.md#create) | **POST** /user-groups | Post a new user group
*UserGroupsApi* | [**Delete**](docs/UserGroupsApi.md#delete) | **DELETE** /user-groups/{rkUserGroupId} | Delete a user group
*UserGroupsApi* | [**DisassociateUserFromGroup**](docs/UserGroupsApi.md#disassociateuserfromgroup) | **DELETE** /user-groups/{rkUserGroupId}/users/{rkUserId} | Remove a user from a user group
*UserGroupsApi* | [**GetAll**](docs/UserGroupsApi.md#getall) | **GET** /user-groups | Search User Groups
*UserGroupsApi* | [**GetUserGroupById**](docs/UserGroupsApi.md#getusergroupbyid) | **GET** /user-groups/{rkUserGroupId} | Get User Group details by ID
*UserGroupsApi* | [**GetUserGroupUsers**](docs/UserGroupsApi.md#getusergroupusers) | **GET** /user-groups/{rkUserGroupId}/users | List users of a user group
*UserGroupsApi* | [**Update**](docs/UserGroupsApi.md#update) | **PUT** /user-groups/{rkUserGroupId} | Update an existing user group
*UsersApi* | [**AssociateHomePageToUser**](docs/UsersApi.md#associatehomepagetouser) | **POST** /users/{rkUserId}/homepages/{rkHomePageId} | Add a homepage to a user
*UsersApi* | [**AssociateRoleToUser**](docs/UsersApi.md#associateroletouser) | **POST** /users/{rkUserId}/roles/{rkRoleId} | Associate a role to a user
*UsersApi* | [**ChangePassword**](docs/UsersApi.md#changepassword) | **POST** /users/{rkUserId}/password | Set or change a user's password
*UsersApi* | [**CreateUser**](docs/UsersApi.md#createuser) | **POST** /users | Create a new user
*UsersApi* | [**DeleteUser**](docs/UsersApi.md#deleteuser) | **DELETE** /users/{rkUserId} | Delete a user
*UsersApi* | [**DisassociateHomepageFromUser**](docs/UsersApi.md#disassociatehomepagefromuser) | **DELETE** /users/{rkUserId}/homepages/{rkHomePageId} | Delete a homepage from a user's list of homepages
*UsersApi* | [**DisassociateRoleFromUser**](docs/UsersApi.md#disassociaterolefromuser) | **DELETE** /users/{rkUserId}/roles/{rkRoleId} | Delete a role from a user
*UsersApi* | [**GetGroupsOfUser**](docs/UsersApi.md#getgroupsofuser) | **GET** /users/{rkUserId}/user-groups | List the user groups a user is a member of
*UsersApi* | [**GetHomepagesByUserId**](docs/UsersApi.md#gethomepagesbyuserid) | **GET** /users/{rkUserId}/homepages | Get the user's homepages
*UsersApi* | [**GetRolesByUserId**](docs/UsersApi.md#getrolesbyuserid) | **GET** /users/{rkUserId}/roles | Get the roles for a user
*UsersApi* | [**GetUserById**](docs/UsersApi.md#getuserbyid) | **GET** /users/{rkUserId} | Get a user by ID
*UsersApi* | [**GetUsers**](docs/UsersApi.md#getusers) | **GET** /users | Search users
*UsersApi* | [**UpdateUser**](docs/UsersApi.md#updateuser) | **PUT** /users/{rkUserId} | Update details of a user
...
*VersionsApi* | [**CreateVersionRequest**](docs/VersionsApi.md#createversionrequest) | **POST** /versions/createVersionRequests | Request processing submitted change events for External Rules
...
*VersionsApi* | [**GetAuditDataByReadableKeyVersionId**](docs/VersionsApi.md#getauditdatabyreadablekeyversionid) | **GET** /versions/{rkVersionId}/audit | Get audit event data for an element version
*VersionsApi* | [**GetCreateVersionRequestById**](docs/VersionsApi.md#getcreateversionrequestbyid) | **GET** /versions/createVersionRequests/{requestId} | Get updated state of element version change requests
...
*VersionsApi* | [**GetElementVersionAttributes**](docs/VersionsApi.md#getelementversionattributes) | **GET** /versions/{rkVersionId}/attributes | Get element version attributes by ID
*VersionsApi* | [**GetElementVersionContent**](docs/VersionsApi.md#getelementversioncontent) | **GET** /versions/{rkVersionId}/content | Get element version content by ID
*VersionsApi* | [**GetElementVersionDetailsById**](docs/VersionsApi.md#getelementversiondetailsbyid) | **GET** /versions/{rkVersionId} | Get element version details by ID
...
*VersionsApi* | [**GetHistoricalElementVersions**](docs/VersionsApi.md#gethistoricalelementversions) | **GET** /versions | Search all element versions
*VersionsApi* | [**GetLatestElementVersions**](docs/VersionsApi.md#getlatestelementversions) | **GET** /versions/latest | Search for latest element versions only
...
*WaiversApi* | [**GetWaiverById**](docs/WaiversApi.md#getwaiverbyid) | **GET** /waivers/{rkWaiverId} | Get waiver details by ID.
*WaiversApi* | [**GetWaivers**](docs/WaiversApi.md#getwaivers) | **GET** /waivers | Search waivers


<a name="documentation-for-models"></a>
## Documentation for Models

 - [Model.AttributeValue](docs/AttributeValue.md)
